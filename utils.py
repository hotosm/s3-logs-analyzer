...
def generate_full_report_email(df, presigned_url_csv, verbose=True):
    ...
    email_body += f"<a href='{presigned_url_csv}' style='background-color: #D73F3F; color: white; padding: 5px 10px; text-align: center; text-decoration: none; display: inline-block; font-size: 12px; margin: 2px 1px; cursor: pointer; border-radius: 5px;'>Download Full Data</a>"
